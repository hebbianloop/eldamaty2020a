...
\def\Authors{Shady El Damaty\,$^{1*}$, Yewon Chun}
% Affiliations should be keyed to the author's name with superscript numbers and be listed as follows: Laboratory, Institute, Department, Organization, City, State abbreviation (USA, Canada, Australia), and Country (without detailed address information such as city zip codes or street names).
% If one of the authors has a change of address, list the new address below the correspondence details using a superscript symbol and use the same symbol to indicate the author in the author list.
\def\Address{$^{1}$Center for Functional \& Molecular Imaging, Georgetown University Medical Center, Department of Neurology, Interdisciplinary Program in Neuroscience, Washington, District of Columbia, USA 
...
\title{Social-Strain Cascades from Adolescence into Violence Experience and Altered Social Norms in Emerging Adulthood} 
...
\tiny
 \keyFont{ \section{Keywords:} adolescence, risk, adversity, violence, development} %All article types: you may provide up to 8 keywords; at least 5 are mandatory.
\end{abstract}

\section{Introduction}
%%%% significance 
\paragraph{Background}
The transition from adolescence to adulthood is the riskiest period during lifespan development for the occurrence of an adverse outcome. Youth at this juncture are 
...
% general strain model brief review
...
% < something else is needed here? relating how violence experience is a positive feedback loop for deviance + more violence experience > 
% < add references from moffit, agnew, zbrezna, piquiro, etc >
% study design intro  & hypotheses
